...
<<<<<<< HEAD
  Target, Activity, BarChart2, Calendar,
...
<<<<<<< HEAD
  ...
  const targetCalories = userGoals?.calories || 2500;
  const targetProtein = Math.round((targetCalories * 0.3) / 4); 

  const goals = [
    { label: 'Calorii Arse', current: currWeekBurned, target: targetCalories * 1.5, unit: 'kcal', color: '#f97316', icon: Flame },
...
<<<<<<< HEAD
                {currentStreak >= 7 ? '🔥 O săptămână perfectă!' : currentStreak > 0 ? 'Consistența este cheia!' : 'Începe azi!'}
=======
...
<<<<<<< HEAD
        {/* ── ROW 2: Charts Tabs + Macros (H-FULL pentru echilibru) ── */}
        <motion.div variants={containerVariants} initial="hidden" animate="show" className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
...
<<<<<<< HEAD
              <div className="flex-1 flex flex-col justify-end">
                <AnimatePresence mode="wait">
                  {/* TAB: CALORII */}
                  {activeTab === 'calorii' && (
                    <motion.div key="calorii" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="h-full flex flex-col justify-end">
                      ...
                      <div className="flex items-end justify-between gap-2 sm:gap-3 h-64 w-full relative">
                  ...
                  {/* TAB: MACROS */}
                  {activeTab === 'macros' && (
                    <motion.div key="macros" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="h-full flex flex-col justify-center">
                      <div className="flex flex-col items-center justify-center w-full gap-6">
                        <p className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-4">Media zilnică pe ultimele 7 zile</p>
                        <div className="flex flex-row justify-center gap-12 sm:gap-24 w-full">
                          <RingProgress value={avgCalories} max={targetCalories} color="#f97316" size={160} strokeWidth={14} label="Calorii" sublabel={`${avgCalories} / ${targetCalories} kcal`} />
                          <RingProgress value={avgMacros?.protein || 0} max={targetProtein} color="#d946ef" size={160} strokeWidth={14} label="Proteine" sublabel={`${avgMacros?.protein || 0} / ${targetProtein} g`} />
                        </div>
                      </div>
                    </motion.div>
                  )}
                  ...
                  {/* TAB: HIDRATARE */}
                  {activeTab === 'hidratare' && (
                    <motion.div key="hidratare" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="h-full flex flex-col justify-end">
          ...
          {/* BADGES + TOTAL ARSE (EXTINSE) */}
          <motion.div variants={itemVariants} className="lg:col-span-4 flex flex-col gap-6 h-full">
            ...
            <div className="bg-black/40 border border-fuchsia-500/15 p-7 rounded-[28px] backdrop-blur-xl group hover:border-fuchsia-500/30 transition-all relative overflow-hidden shrink-0">
              ...
              <div className="relative z-10">
                <div className="text-6xl font-black text-white tracking-tighter drop-shadow-[0_0_20px_#d946ef]">
...
<<<<<<< HEAD
            {/* BADGES - Ocupă tot spațiul rămas */}
              ...
              <div className="grid grid-cols-2 gap-4 flex-1">
                {[
                  ...
                  <motion.div key={key}
                    ...
                    className={`p-5 rounded-[20px] flex flex-col items-center justify-center text-center gap-3 transition-all border relative overflow-hidden
=======
            {/* BADGES */}
...
<<<<<<< HEAD
                    ...
                    <Icon size={32} style={unlocked ? { color, filter: `drop-shadow(0 0 10px ${color})` } : { color: '#4b5563' }} />
                    <div>
...
<<<<<<< HEAD
            {/* Trimitem datele REALE catre componenta de calendar */}
=======
>>>>>>> 7d8d662932080c3b7c61cdb15b661648b8911fc2
